...
class _UpdateDeviceScreenState extends State<UpdateDeviceScreen> {
  ...
  final TextEditingController installedLocationController =
      TextEditingController();
  final TextEditingController vendorAMCPartnerController =
      TextEditingController();
  final TextEditingController configurationDetailsController =
      TextEditingController();
  final TextEditingController maintenanceHistoryController =
      TextEditingController();
  final TextEditingController nextServiceDueDateController =
      TextEditingController();
  ...
  void _submitForm(ApiProvider provider) {
    if (_formKey.currentState?.validate() ?? false) {
      final body = {
        ...
        "nextServiceDue": _nextServiceDueDateDate!.toIso8601String().split(
          'T',
        )[0], // YYYY-MM-DD format
